package deeplearning4j.smile.code_examples.LinearRegression
...
object LinearRegression extends SimpleSwingApplication {
  def top = new MainFrame {
    ...
    val basePath = "subprojects/machinelearning/src/main/scala/smile/example_data/OLS_Regression_Example_3.csv"
