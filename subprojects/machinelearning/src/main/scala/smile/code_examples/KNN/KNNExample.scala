package deeplearning4j.smile.code_examples.KNN
...
object KNNExample extends SimpleSwingApplication {
  def top = new MainFrame {
    ...
    val basePath = new File("subprojects/machinelearning/src/main/scala/smile/example_data/KNN_Example_1.csv").getAbsolutePath
