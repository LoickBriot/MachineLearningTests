package deeplearning4j.smile.code_examples.SVM
...
object SVM_Example_2 extends SimpleSwingApplication {
  ...
  def top = new MainFrame {
    ...
    val trainingPath =  "subprojects/machinelearning/src/main/scala/smile/example_data/SVM_Example_2.csv"
    val testingPath = "subprojects/machinelearning/src/main/scala/smile/example_data/SVM_Example_2_Test_data.csv"
