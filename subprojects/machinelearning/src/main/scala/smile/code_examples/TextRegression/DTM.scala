package deeplearning4j.smile.code_examples.TextRegression
...
class DTM {
  ...
  def getStopWords(): List[String] = {
    val source = scala.io.Source.fromFile(new File("subprojects/regression/src/main/scala/clustering/smile/example_data/stopwords.txt"))("latin1")
